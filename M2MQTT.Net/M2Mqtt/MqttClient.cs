...
namespace uPLibrary.Networking.M2Mqtt
{
    ...
    {
        public int L_Index;
        public uint rpc_CNT=0;
        public string Last_rpc;
        public string PLC_IP;

        public UDPSocket udp_client;

        public void RPC_CNT()
        {
           rpc_CNT++;
        }
            public string Get_Info_RPC( )
        {
            return rpc_CNT.ToString() + Last_rpc;
        ...
        public ushort messageIdCounter = 0;
	...
	/// <summary>
            ...
            string password)
        {
            ...
            try
            {
                ...
                reti= this.Connect(clientId, username, password, false, MqttMsgConnect.QOS_LEVEL_AT_MOST_ONCE, false, null, null, true, MqttMsgConnect.KEEP_ALIVE_PERIOD_DEFAULT);
                    ...
                    if (readBytes > 0)
                    {
                        ...
                        switch (msgType)
                        {
                            ...
                            case MqttMsgBase.MQTT_MSG_SUBACK_TYPE:
                                ...
                                MqttMsgSuback suback = MqttMsgSuback.Parse(fixedHeaderFirstByte[0],1/* ((byte)this.ProtocolVersion)*/, this.channel);
#if TRACE
